...
describe("amazonPromo", () => {
    ...
    describe("amazonSearchPromo", () => {
        ...
        it("should return promotions and total count", async () => {
            ...
            amazonPromotion_1.AmazonPromotion.find.mockResolvedValue(mockPromotions);
        ...
        it("should return an error if the search fails", async () => {
            ...
            amazonPromotion_1.AmazonPromotion.find.mockRejectedValue(mockError);
            const response = await (0, supertest_1.default)(__1.app)
                .post("/am/v1/promotions/search")
                .send({
                predicates: [],
    ...
    describe("amazonGetPromoById", () => {
        it("should return a promotion if it exists", async () => {
            ...
            amazonPromotion_1.AmazonPromotion.findOne.mockResolvedValue(mockPromotion);
            const response = await (0, supertest_1.default)(__1.app).get("/am/v1/promotions/123");
            expect(response.status).toBe(responseCodes_1.RESPONSE_CODE_OK);
            expect(response.body).toEqual(mockPromotion);
        });
        it("should return an error if the promotion does not exist", async () => {
            amazonPromotion_1.AmazonPromotion.findOne.mockResolvedValue(null);
            const response = await (0, supertest_1.default)(__1.app).get("/am/v1/promotions/123");
        ...
        it("should return an error if the database query fails", async () => {
            ...
            amazonPromotion_1.AmazonPromotion.findOne.mockRejectedValue(mockError);
            const response = await (0, supertest_1.default)(__1.app).get("/am/v1/promotions/123");
            expect(response.status).toBe(responseCodes_1.RESPONSE_CODE_SERVER_ERROR);
    ...
    describe("amazonSavePromo", () => {
        ...
        it("should create a new Multi Promo if one does not already exist", async () => {
            amazonPromotion_1.MultiAmazonPromotion.findOne.mockResolvedValue(null);
            amazonPromotion_1.MultiAmazonPromotion.prototype.save.mockResolvedValue(mockSaveMultiPromo);
            const response = await (0, supertest_1.default)(__1.app)
        ...
        it("should update an existing Multi Promo if one already exists", async () => {
            ...
            amazonPromotion_1.MultiAmazonPromotion.findOne.mockResolvedValue(mockSaveMultiPromoDoc);
            amazonPromotion_1.MultiAmazonPromotion.prototype.save.mockResolvedValue(mockSaveMultiPromoDoc);
            const response = await (0, supertest_1.default)(__1.app)
                .post("/am/v1/promotions/save")
                .send(mockSaveMultiPromo);
            expect(response.status).toBe(responseCodes_1.RESPONSE_CODE_OK);
        ...
        it("should create a new Price Based Promo if one does not already exist", async () => {
            amazonPromotion_1.PriceBasedAmazonPromotion.findOne.mockResolvedValue(null);
            amazonPromotion_1.PriceBasedAmazonPromotion.prototype.save.mockResolvedValue(mockPriceBasedPromo);
            const response = await (0, supertest_1.default)(__1.app)
                .post("/am/v1/promotions/save")
        ...
        it("should update an existing Price Based Promo if one already exists", async () => {
            ...
            amazonPromotion_1.MultiAmazonPromotion.findOne.mockResolvedValue(mockPriceBasePromoDoc);
            amazonPromotion_1.MultiAmazonPromotion.prototype.save.mockResolvedValue(mockPriceBasePromoDoc);
            const response = await (0, supertest_1.default)(__1.app)
                .post("/am/v1/promotions/save")
                .send(mockPriceBasedPromo);
            expect(response.status).toBe(responseCodes_1.RESPONSE_CODE_OK);
